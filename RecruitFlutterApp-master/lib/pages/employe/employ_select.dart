...
import 'package:recruit_app/pages/jobs/all/collection_button.dart';
import 'package:recruit_app/pages/jobs/all/companytypes_model.dart';
import 'package:recruit_app/pages/utils/screen.dart';



class EmployTypeSelect extends StatefulWidget {
  final double height;
  final Color themeColor;
  final ValueChanged<Map> onSureButtonClick;

  EmployTypeSelect({Key key,this.height,this.themeColor,this.onSureButtonClick}) :super(key:key);
  @override
  _EmployTypeSelectState createState() => _EmployTypeSelectState();
}

class _EmployTypeSelectState extends State<EmployTypeSelect> {
